...
class MockDataService {
  ...
  static List<Station> getStations() {
    return const [
      ...
      Station(
        id: 's2',
        name: 'Shell Fjøsanger',
        brand: 'Shell',
        address: 'Cecilie Thoresens vei 13',
        city: 'Oslo',
        latitude: 59.8753,
        longitude: 10.8105,
      ),
      ...
      Station(
        id: 's14',
        name: 'Circle K Mariero',
        brand: 'Circle K',
        address: 'Marieroveien',
        city: 'Stavanger',
        latitude: 58.9340,
        longitude: 5.7424,
      ),
